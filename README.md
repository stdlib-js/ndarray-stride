...
```javascript
import stride from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-stride@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-stride/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/ndarray-stride/actions/workflows/test.yml?query=branch:v0.2.3
